                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title">ENMODA 2015 REFORÇA PARCERIA DO SENAI COM INDÚSTRIAS</h3>
                            <h4>Em Criciúma, macrotendências para o inverno 2017, criadas pelos estudantes do Curso Superior Design de Moda do SENAI e UNESC, serão apresentadas por acadêmicos, nesta quarta-feira, dia 2, no Siso's Hall</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <p>FIESC Imprensa</p>
                            <p>Com informações de Ana Sofia Schuster</p>
                            <p>Novo Texto Comunicação/Criciúma</p>
                        </div>
            ...
            <div id="noticia2" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h3 class="modal-title">WORKSHOP MOSTRA GANHOS COM A ATUALIZAÇÃO DOS MOTORES INDUSTRIAIS</h3>
                            <h4>Evento na FIESC debateu a importância da adoção de motores mais eficientes para o aumento na competitividade do setor produtivo</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <p>Fábio Almeida</p>
                            <p>Assessoria de Imprensa da FIESC</p>
                            <p>48 3231-4674 | 48 9981-4642</p>
                            <p>fabio.almeida@fiesc.com.br</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                        </div>
            ...
            <div id="noticia3" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h3 class="modal-title">EM DOIS ANOS, PROGRAMA NOVOS CAMINHOS ATENDEU 426 JOVENS EM SC</h3>
                            <h4>Parceria entre FIESC, TJSC e AMC atende jovens e adolescentes sob a tutela do Estado, em programas de acolhimento</h4>
                        </div>
                        <div class="modal-body">
