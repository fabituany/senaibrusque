            ...
            <form role="form" id="contactForm">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Digite seu nome" required data-error="Campo obrigatório.">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="email" class="h4">E-mail</label>
                        <input type="email" class="form-control" id="email" placeholder="Digite seu e-mail" required data-error="Campo obrigatório.">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="message" class="h4 ">Mensagem</label>
                    <textarea id="message" class="form-control" rows="5" placeholder="Digite sua mensagem" required data-error="Campo obrigatório."></textarea>
                    <div class="help-block with-errors"></div>
                </div>
